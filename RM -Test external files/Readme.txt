...
To install and use:
1-  Download and install Python for Windows x64 (use default options)  -see below
2-  Download unifuzz64.dll   -see below
3-  Create a folder on disk and copy these files to it-
