...
#   input citation name
#   confirm there is only 1 match to like input across all citations
 ...
 WHERE Name LIKE ( ? || '%' )
  """
        ...
        if (NewSourceID == OldSourceID):
            print('PROBLEM: The citation is already using the specified new source.')
            continue
